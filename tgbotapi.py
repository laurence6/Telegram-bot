...
class BOT(object):
    ...
    def getUpdates(self, offset=0, limit=100, timeout=0):
        ...
        return requests.get(self.baseurl+'getUpdates', params={'offset': offset, 'limit': limit, 'timeout':timeout}).json()

    def sendMessage(self, chat_id, text, disable_web_page_preview=None, reply_to_message_id=None, reply_markup=None):
        '''https://core.telegram.org/bots/api#sendmessage'''
        return requests.post(self.baseurl+'sendMessage', params={'chat_id': chat_id, 'text': text, 'disable_web_page_preview': disable_web_page_preview, 'reply_to_message_id': reply_to_message_id, 'reply_markup': reply_markup}).json()

    def sendPhoto(self, chat_id, photo, caption=None, reply_to_message_id=None, reply_markup=None):
        '''https://core.telegram.org/bots/api#sendphoto'''
        if isinstance(photo, str):
            return requests.post(self.baseurl+'sendPhoto', params={'chat_id': chat_id, 'photo': photo, 'caption': caption, 'reply_to_message_id': reply_to_message_id, 'reply_markup': reply_markup}).json()
    ...
    def sendDocument(self, chat_id, document, reply_to_message_id=None, reply_markup=None):
        ...
        if isinstance(document, str):
            return requests.post(self.baseurl+'sendDocument', params={'chat_id': chat_id, 'document': document, 'reply_to_message_id': reply_to_message_id, 'reply_markup': reply_markup}).json()
        elif isinstance(document, (list, tuple)):
            return requests.post(self.baseurl+'sendDocument', params={'chat_id': chat_id,                       'reply_to_message_id': reply_to_message_id, 'reply_markup': reply_markup}, files={'document': document}).json()

    def sendLocation(self, chat_id, latitude, longitude, reply_to_message_id=None, reply_markup=None):
        '''https://core.telegram.org/bots/api#sendlocation'''
        return requests.post(self.baseurl+'sendLocation', params={'chat_id': chat_id, 'latitude': latitude, 'longitude': longitude, 'reply_to_message_id': reply_to_message_id, 'reply_markup': reply_markup}).json()
